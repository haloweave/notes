        ...
        <aside className="w-64 h-screen bg-white border-r shadow-sm flex flex-col shrink-0 sticky top-0">
            ...
            <nav className="flex-1 p-4 space-y-2">
                ...
                >
                    <Link href="/dashboard/create">
                        <AddCircleIcon className="mr-3 h-7 w-7 shrink-0 stroke-[2]" />
                        Create New
                    </Link>
                </Button>
                ...
                >
                    <Link href="/dashboard">
                        <FolderMusicIcon className="mr-3 h-7 w-7 shrink-0 stroke-[2]" />
                        My Songs
                    </Link>
                </Button>
                ...
                >
                    <Link href="/dashboard/orders">
                        <Invoice01Icon className="mr-3 h-7 w-7 shrink-0 stroke-[2]" />
                        Orders
                    </Link>
                </Button>
                <Button
                ...
                >
                    <Link href="/dashboard/settings">
                        <Settings01Icon className="mr-3 h-7 w-7 shrink-0 stroke-[2]" />
                        Settings
                    </Link>
                </Button>
            </nav>
            ...
            <div className="p-4 border-t bg-gray-50">
                <div className="user-info flex items-center gap-3 mb-4 p-3 bg-white rounded-lg shadow-sm border border-gray-100">
                    <div className="user-avatar bg-gray-100 p-2.5 rounded-full flex items-center justify-center">
                ...
                >
                    <Logout01Icon className="mr-3 h-6 w-6 stroke-[2]" />
                    Log Out
                </Button>
            </div>
        </aside>
