                ...
                <div className="md:hidden space-y-8 pb-12">
                    ...
                    <div className="space-y-4">
                        <div
                            ...
                            className="cursor-pointer transition-all duration-300 w-[90%] mx-auto bg-transparent rounded-2xl overflow-hidden relative shadow-[0_8px_30px_rgba(135,206,235,0.2)] border-2 border-[#87CEEB]"
                        >
                    ...
                    <div className="space-y-4 relative pt-4">
                        ...
                        <div
                            ...
                            className="cursor-pointer transition-all duration-300 w-[90%] mx-auto bg-transparent rounded-2xl overflow-hidden relative shadow-[0_8px_30px_rgba(245,236,212,0.2)] border-2 border-[#f5ecd4]"
                        >
                ...
                <div className="hidden md:block">
                    <div className="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-4xl mx-auto">
                        ...
                        <div className="space-y-6">
                            <div
                                onClick={() => handleSelect('solo-serenade')}
                                className="cursor-pointer transition-all duration-300 w-full hover:-translate-y-2 bg-transparent rounded-2xl overflow-hidden relative shadow-[0_8px_30px_rgba(135,206,235,0.2)] hover:shadow-[0_15px_40px_rgba(135,206,235,0.4)] border-2 border-[#87CEEB] group"
                            >
                        ...
                        <div className="space-y-6 relative">
                            ...
                            <div
                                onClick={() => handleSelect('holiday-hamper')}
                                className="cursor-pointer transition-all duration-300 w-full hover:-translate-y-2 bg-transparent rounded-2xl overflow-hidden relative shadow-[0_8px_30px_rgba(245,236,212,0.2)] hover:shadow-[0_15px_40px_rgba(245,236,212,0.4)] border-2 border-[#f5ecd4] group mt-4"
                            >
                                {/* Image Container - Full display */}
                                <div className="w-full relative">
                                    <Image
